...
var _servicesFeedMock = require('./services/feed-mock');
...
var _modulesHeader = require('./modules/Header');

var _modulesHeader2 = _interopRequireDefault(_modulesHeader);

var _modulesStockGrid = require('./modules/StockGrid');

var _modulesStockGrid2 = _interopRequireDefault(_modulesStockGrid);

var _modulesBuyWindow = require('./modules/BuyWindow');

var _modulesBuyWindow2 = _interopRequireDefault(_modulesBuyWindow);

var _modulesSellWindow = require('./modules/SellWindow');

var _modulesSellWindow2 = _interopRequireDefault(_modulesSellWindow);
...
var App = _react2['default'].createClass({
    ...
    sellHandler: function sellHandler(stock) {
    ...
    removeHandler: function removeHandler(stock) {
        feed.unwatch(stock.symbol);
        var stocks = this.state.stocks;
        delete stocks[stock.symbol];
        this.setState({ stocks: stocks });
    },
    sortHandler: function sortHandler(value, label) {},
    ...
    render: function render() {
        return _react2['default'].createElement(
            ...
            _react2['default'].createElement(_modulesStockGrid2['default'], { stocks: this.state.stocks, last: this.state.last,
...
var ButtonDropdown = _react2["default"].createClass({
    ...
    changeHandler: function changeHandler(value, label, icon) {
    ...
    render: function render() {
        ...
        var className = "slds-button slds-button--icon-more";
        return _react2["default"].createElement(
            "div",
            { className: "slds-dropdown-trigger", "aria-haspopup": "true" },
            _react2["default"].createElement(
                "button",
                { className: className, "aria-haspopup": "true" },
                _react2["default"].createElement(_Icons.ButtonIcon, { name: icon || this.props.icon }),
                _react2["default"].createElement(
                    "span",
...
},{"./Icons":159,"react":156}],159:[function(require,module,exports){
'use strict';
...
exports["default"] = _react2["default"].createClass({
    ...
    qtyChange: function qtyChange(event) {
                ...
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            ...
                            _react2["default"].createElement(
                                "fieldset",
                                { className: "slds-form--compound slds-m-bottom--medium" },
                                _react2["default"].createElement(
                                    "div",
                                    ...
                                    _react2["default"].createElement(
                                        ...
                                        _react2["default"].createElement(
                                            ...
                                            _react2["default"].createElement(
                                                ...
                                                _react2["default"].createElement(
                                                    "span",
                                                    { style: { color: this.props.stock.change < 0 ? "red" : "green" } },
                                                    this.props.stock.last
                                                ),
                                                _react2["default"].createElement(_componentsIcons.Icon, { category: "utility", name: this.props.stock.change < 0 ? "down" : "up", size: "x-small", color: this.props.stock.change < 0 ? "red" : "green" })
                                            )
                                        ),
                                        _react2["default"].createElement(
                                            "label",
                                            ...
                                            _react2["default"].createElement("input", { className: "slds-input", type: "text", value: this.state.qty, onChange: this.qtyChange })
                                        ),
                                        _react2["default"].createElement(
                                            "label",
                                            { className: "slds-form-element__control slds-size--1-of-4" },
                                            ...
                                            _react2["default"].createElement(
                                                "div",
                                                null,
                                                parseFloat(this.props.stock.last * this.state.qty).toLocaleString('en-US', { style: 'currency', currency: 'USD' })
                                            )
                                        )
                                    )
                                )
...
exports["default"] = _react2["default"].createClass({
    ...
    render: function render() {
        var viewItems = undefined;
        var sortItems = undefined;
        if (this.props.viewOptions) {
            viewItems = this.props.viewOptions.map(function (item) {
                return _react2["default"].createElement(_componentsDropdown.DropdownItem, { value: item.value, label: item.label, icon: item.icon });
            });
        }
        if (this.props.sortOptions) {
            sortItems = this.props.sortOptions.map(function (item) {
                return _react2["default"].createElement(_componentsDropdown.DropdownItem, { value: item.value, label: item.label });
            });
        }
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            ...
                            _react2["default"].createElement(
                                ...
                                { header: "Display as", iconMore: true, value: this.props.viewOptions[0].value, onChange: this.props.onViewChange },
                                viewItems
                            )
                        ),
                        _react2["default"].createElement(
                            ...
                            _react2["default"].createElement(
                                _componentsDropdown.ButtonDropdown,
                                { header: "Sort By", icon: "sort", iconMore: true, onChange: this.props.onSort },
                                sortItems
                            )
                        ),
                        _react2["default"].createElement(
                            ...
                            _react2["default"].createElement(
                                ...
                                _react2["default"].createElement(
                                    ...
                                    _react2["default"].createElement(
                                        ...
                                        _react2["default"].createElement(
                                            "label",
                                            { className: "slds-form-element__control slds-size--1-of-5" },
                                            _react2["default"].createElement(
                                                "small",
                                                { className: "slds-form-element__helper" },
                                                "Symbol"
...
var StockRow = _react2["default"].createClass({
    ...
    render: function render() {
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                "td",
                { "data-label": "open", style: { textAlign: "right" } },
                _react2["default"].createElement(
                    "span",
                    null,
            ...
            _react2["default"].createElement(
                "td",
                { "data-label": "last", style: { textAlign: "right", backgroundColor: lastBackgroundColor } },
                _react2["default"].createElement(
                    "span",
                    null,
                    this.props.stock.last
            ...
            _react2["default"].createElement(
                "td",
                { "data-label": "change", style: { textAlign: "right" } },
                _react2["default"].createElement(
                    "span",
                    { style: { color: this.props.stock.change < 0 ? "red" : "green" } },
            ...
            _react2["default"].createElement(
                "td",
                { "data-label": "high", style: { textAlign: "right" } },
                _react2["default"].createElement(
                    "span",
                    null,
            ...
            _react2["default"].createElement(
                "td",
                { "data-label": "low", style: { textAlign: "right" } },
                _react2["default"].createElement(
                    "span",
                    null,
            ...
            _react2["default"].createElement(
                ...
                { style: { width: "50px" } },
                _react2["default"].createElement(
                    _componentsDropdown.ActionButton,
                    { onChange: this.actionHandler },
                    _react2["default"].createElement(_componentsDropdown.DropdownItem, { label: "Buy" }),
                    _react2["default"].createElement(_componentsDropdown.DropdownItem, { label: "Sell" }),
                    _react2["default"].createElement(_componentsDropdown.DropdownItem, { label: "Remove" })
                )
            )
        );
    }
...
exports["default"] = _react2["default"].createClass({
    ...
    linkHandler: function linkHandler(property) {
    ...
    sortHandler: function sortHandler(col) {
    ...
    render: function render() {
        ...
        for (var symbol in this.props.stocks) {
            ...
            rows.push(_react2["default"].createElement(StockRow, { key: stock.symbol, stock: stock, last: this.props.last,
        ...
        rows.sort(function (a, b) {
            return a.props.stock[_this.state.sortField] < b.props.stock[_this.state.sortField] ? -1 : 1;
        });
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        "th",
                        { className: "slds-is-sortable", scope: "col" },
                        _react2["default"].createElement(
                            "span",
                        ...
                        _react2["default"].createElement(
                            "button",
                            { className: "slds-button slds-button--icon-bare slds-button--icon-border-small", onClick: this.sortHandler.bind(this, 'symbol') },
                            _react2["default"].createElement(_componentsIcons.ButtonIcon, { name: "arrowdown", size: "--small" }),
                            _react2["default"].createElement(
                                "span",
                                { className: "slds-assistive-text" },
                                "Sort"
                    ...
                    _react2["default"].createElement(
                        "th",
                        { className: "slds-is-sortable", scope: "col", style: { textAlign: "right", width: "110px" } },
                        _react2["default"].createElement(
                            "span",
                            { className: "slds-truncate" },
                            "Open"
                        ...
                        _react2["default"].createElement(
                            "button",
                            { className: "slds-button slds-button--icon-bare slds-button--icon-border-small", onClick: this.sortHandler.bind(this, 'open') },
                            _react2["default"].createElement(_componentsIcons.ButtonIcon, { name: "arrowdown", size: "--small" }),
                            _react2["default"].createElement(
                                "span",
                                { className: "slds-assistive-text" },
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            "button",
                            { className: "slds-button slds-button--icon-bare slds-button--icon-border-small", onClick: this.sortHandler.bind(this, 'last') },
                            _react2["default"].createElement(_componentsIcons.ButtonIcon, { name: "arrowdown", size: "--small" }),
                            _react2["default"].createElement(
                                "span",
                                { className: "slds-assistive-text" },
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            "button",
                            { className: "slds-button slds-button--icon-bare slds-button--icon-border-small", onClick: this.sortHandler.bind(this, 'change') },
                            _react2["default"].createElement(_componentsIcons.ButtonIcon, { name: "arrowdown", size: "--small" }),
                            _react2["default"].createElement(
                                "span",
                                { className: "slds-assistive-text" },
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            "button",
                            { className: "slds-button slds-button--icon-bare slds-button--icon-border-small", onClick: this.sortHandler.bind(this, 'high') },
                            _react2["default"].createElement(_componentsIcons.ButtonIcon, { name: "arrowdown", size: "--small" }),
                            _react2["default"].createElement(
                                "span",
                                { className: "slds-assistive-text" },
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            "button",
                            { className: "slds-button slds-button--icon-bare slds-button--icon-border-small", onClick: this.sortHandler.bind(this, 'low') },
                            _react2["default"].createElement(_componentsIcons.ButtonIcon, { name: "arrowdown", size: "--small" }),
                            _react2["default"].createElement(
                                "span",
                                { className: "slds-assistive-text" },
...
var stocks = [{ symbol: "GM", open: 38.87 }, { symbol: "GE", open: 25.40 }, { symbol: "MCD", open: 97.05 }, { symbol: "UAL", open: 69.45 }, { symbol: "WMT", open: 83.24 }, { symbol: "AAL", open: 55.76 }, { symbol: "LLY", open: 76.12 }, { symbol: "JPM", open: 61.75 }, { symbol: "BAC", open: 15.84 }, { symbol: "BA", open: 154.50 }];
...
var watch = function watch(symbols) {
...
exports.watch = watch;
var unwatch = function unwatch(symbol) {
