                ...
                <div aria-hidden="false" role="dialog" className="slds-modal slds-fade-in-open">
                    <div className="slds-modal__container">
                        <div className="slds-modal__header">
                            <h2 className="slds-text-heading--medium">Sell Order</h2>
                                ...
                                <fieldset className="slds-form--compound slds-m-bottom--medium">
                                    <div className="form-element__group">
                                        <div className="slds-form-element__row">
                                            <label className="slds-form-element__control slds-size--1-of-5">
                                                <small className="slds-form-element__helper">Symbol</small>
                                                <div>{this.props.stock.symbol}</div>
                                            </label>
                                            <label className="slds-form-element__control slds-size--1-of-5">
                                                <small className="slds-form-element__helper">Available</small>
                                                <div>800</div>
                                            </label>
                                            <label className="slds-form-element__control slds-size--1-of-5">
                        ...
                        <div className="slds-modal__footer">
                            ...
                            <button className="slds-button slds-button--neutral slds-button--brand" onClick={this.onSave}>Sell</button>
                        </div>
                    </div>
                </div>
